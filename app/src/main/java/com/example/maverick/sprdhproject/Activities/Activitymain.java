...
import com.example.maverick.sprdhproject.FakeCallReceiver;
import com.example.maverick.sprdhproject.Permissions;
import com.example.maverick.sprdhproject.R;
import com.example.maverick.sprdhproject.Services.MessageService;
...
//        fakecall = (CardView) findViewById(R.id.cardView3);
        ...
        isSafe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isLocationAvailable()) {
                    Intent intent = new Intent(Activitymain.this, IsSafe.class);
        ...
        police.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isLocationAvailable()) {
                    Intent intent = new Intent(Activitymain.this, Police.class);
                    startActivity(intent);
                }
                else
                {
...
*/
        contacts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activitymain.this, Contact.class);
                startActivity(i);
            }
        });
        ...
        message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MaterialDialog.Builder builder = new MaterialDialog.Builder(Activitymain.this)
                        .title(R.string.input)
                        .inputType(InputType.TYPE_CLASS_TEXT)
                        .input("Enter Here", null, new MaterialDialog.InputCallback() {
                            @Override
                            public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                                mSharedPreferences=getSharedPreferences("sprdh", Context.MODE_PRIVATE);
...
/*    public void setUpAlarm(long selectedTimeInMilliseconds, String fakeName, String fakeNumber){
    ...
    private void startService() {
        Intent intent=new Intent(Activitymain.this,MessageService.class);
 ...
 /*   @Override
    ...
    boolean isLocationAvailable(){
        ...
        if(ActivityCompat.checkSelfPermission(Activitymain.this,Manifest.permission.ACCESS_COARSE_LOCATION)==PackageManager.PERMISSION_GRANTED) {
            LocationManager location = (LocationManager) Activitymain.this.getSystemService(LOCATION_SERVICE);
    ...
    {
        if(ActivityCompat.checkSelfPermission(Activitymain.this,Manifest.permission.ACCESS_COARSE_LOCATION)!=PackageManager.PERMISSION_GRANTED||
                ActivityCompat.checkSelfPermission(Activitymain.this,Manifest.permission.ACCESS_FINE_LOCATION)!=PackageManager.PERMISSION_GRANTED){
            Permissions.askforPermission(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION,
        ...
        {
            AlertDialog.Builder build=new AlertDialog.Builder(Activitymain.this);
